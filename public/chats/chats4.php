<div class="container">
	...
	<div class="ventanaChat" id="ventanaChat4">
		<div class="container">
			<div class="row">
	...
	<div id="inputMensaje">
		<div class="row">
			<div class="input-group mb-3">
				<input id="mensaje4" type="text" class="form-control" placeholder="Introduzca su mensaje" aria-label="Recipient's username" aria-describedby="basic-addon2">
